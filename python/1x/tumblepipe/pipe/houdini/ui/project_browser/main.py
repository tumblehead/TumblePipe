...
from tumblepipe.api import is_dev, path_str, default_client
from tumblepipe.config.timeline import BlockRange, get_frame_range, get_fps
from tumblepipe.config.groups import get_group
from tumblepipe.util.uri import Uri
import tumblepipe.pipe.houdini.nodes as ns
from tumblepipe.pipe.houdini.ui.util import (
...
from tumblepipe.pipe.houdini.sops import export_rig, import_rigs
from tumblepipe.pipe.houdini.cops import build_comp
from tumblepipe.pipe.paths import get_workfile_context, Context
...
class ProjectBrowser(QtWidgets.QWidget):
    ...
    def _create_group(self, name_path):
        ...
        """
        from tumblepipe.pipe.houdini.ui.project_browser.dialogs import GroupEditorDialog
    ...
    def _delete_group(self, name_path):
        ...
        Args:
            name_path: Path list like ["groups", "shots", "group_name"]
        """
        from tumblepipe.config.groups import remove_group
    ...
    def _rebuild_import_export_nodes(self):
        ...
        - import_rig (SOP)
        """
        from tumblepipe.pipe.houdini import rebuild
