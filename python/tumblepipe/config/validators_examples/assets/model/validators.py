"""Model department validators.

This file should be placed at:
    P:\buzz2\_config\validators\assets\model\validators.py

It defines which validators run for the model department.
...
def register(registry):
    """Register validators for the model department.
    ...
    """
    # Model department validation suite
    # For models, we care about correct structure and geometry having rest normals
    registry.register('model_structure', None)
    registry.register('rest_geometry', None)
