...
from tumblepipe.pipe.context import get_aov_names_from_context
...
class SubmitRender(ns.Node):
    ...
    def submit_farm(self):
        ...
        from tumblepipe.farm.jobs.houdini.stage_render import (
    ...
    def submit_cloud(self):
        ...
        # Import the job module
        from tumblepipe.farm.jobs.houdini.cloud_stage_render import (
