...
from tumblepipe.config.farm import list_pools, get_default_pool, get_default_priority
from tumblepipe.config.renderer import get_renderer_defaults
...
def _get_renderer_settings():
    ...
    try:
        ...
        from tumblepipe.config.renderer import RangeSetting, RendererDefaults
