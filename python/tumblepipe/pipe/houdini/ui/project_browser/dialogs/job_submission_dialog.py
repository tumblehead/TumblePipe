...
from tumblepipe.config.groups import list_groups, get_group
...
from tumblepipe.pipe.houdini.ui.project_browser.models.job_submission_table import (
    JobSubmissionTableModel,
)
from tumblepipe.pipe.houdini.ui.project_browser.models.process_task import (
    ProcessTask,
)
from tumblepipe.pipe.houdini.ui.project_browser.widgets import (
    CellSelectionTableView,
    JobSubmissionDelegate,
)
from tumblepipe.pipe.houdini.ui.project_browser.widgets.job_section import (
    JobSectionWidget,
)
...
class JobSubmissionDialog(QtWidgets.QDialog):
    ...
    def _create_submission_tasks(self, configs: list[dict]) -> list[ProcessTask]:
        ...
        """
        from tumblepipe.farm.jobs.houdini import batch_submit
