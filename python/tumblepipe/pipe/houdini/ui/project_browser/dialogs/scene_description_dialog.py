...
from tumblepipe.config.scene import get_scene, set_scene, list_available_assets
from tumblepipe.config.scenes import AssetEntry, DEFAULT_VARIANT
from tumblepipe.config.variants import list_variants, refresh_cache as refresh_variants_cache
...
class SceneDescriptionDialog(QtWidgets.QDialog):
    ...
    def _save_scene(self):
        ...
        try:
            ...
            if len(assets) > 0:
                from tumblepipe.config.scene import generate_root_version
